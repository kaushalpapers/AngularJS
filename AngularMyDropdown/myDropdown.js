function myDropdown() {
    return {
        ...
        link: function (scope, element, attrs) {
            ...
            //add below sectiont till end
             if(txtbox.prop("tagName") != 'input') 
             {
            ...
            list.hover(function () {
                ...
                listItems.hover(function () {
                    listItems.removeClass(listItemHoverClass);
            ...
            function setValue() {
                ...
                if (selectedItem.length > 0) {
                    ...
                    if(txtbox.prop("tagName") != 'input') //add
                        txtbox.html(itemValue);//add
                    else//add
